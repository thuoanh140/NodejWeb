...
let initWebRoutes = (app) => {
    ...
    router.get('/api/get-revenue-food-theater-by-date', movieController.getRevenueFoodTheaterByDate);
    router.get('/api/get-revenue-by-movie', movieController.getRevenueMovie);
    router.get('/api/get-revenue-food-by-theater', movieController.getRevenueFoodByTheater);
